...
def RI_Block(inputs, filters, multiplier):
    ...
    branch1x1 = Conv_Block(inputs, filters, 1, multiplier)

    branch1x1_1 = Conv_Block(inputs, np.int32(filters/2), 1, multiplier)
    branch3x3_1 = Conv_Block(branch1x1_1, math.ceil(filters/6), 3, multiplier)
    branch3x3_2 = Conv_Block(branch3x3_1, math.floor(filters/3), 3, multiplier)
    branch3x3_3 = Conv_Block(branch3x3_2, np.int32(filters/2), 3, multiplier)
...
if __name__ == '__main__':
    ...
    model_name = 'IBAUNet'  # UNet or UNetPP
    ...
    #
    Model = IBAUNet(length, model_depth, num_channel, model_width, problem_type=problem_type, output_nums=output_nums,
