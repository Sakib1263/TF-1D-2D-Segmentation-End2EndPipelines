...
class BCDUNet:
    def __init__(self, length, width, model_depth, model_width, kernel_size, num_channel, problem_type='Regression',
                 output_nums=1, ds=0, ae=0, ag=0, lstm=0, dense_loop=1, feature_number=1024, is_transconv=True):
    ...
    def BCDUNet(self):
        # Variable 2D_BCDUNet Model Design
...
if __name__ == '__main__':
    ...
    model_name = 'BCDUNet'  # Name of the Model
    ...
    #
    Model = BCDUNet(length, width, model_depth, model_width, kernel_size, num_channel, problem_type=problem_type, output_nums=output_nums,
                     ds=D_S, ae=A_E, ag=A_G, lstm=LSTM, dense_loop=num_dense_loop, is_transconv=is_transconv).BCDUNet()
