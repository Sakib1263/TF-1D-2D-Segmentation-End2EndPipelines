...
def Conv_Block(inputs, model_width, kernel, multiplier, strides=1):
...
if __name__ == '__main__':
    ...
    #
    Model = ConvMixer_UNet(length, model_depth, num_channel, model_width, kernel_size, problem_type=problem_type, output_nums=output_nums,
