...
class BCDUNet:
    def __init__(self, length, model_depth, num_channel, model_width, kernel_size, problem_type='Regression',
                 output_nums=1, ds=1, ae=0, ag=0, lstm=0, dense_loop=1, feature_number=1024, is_transconv=True):
...
if __name__ == '__main__':
    ...
    model_name = 'BCDUNet'  # UNet or UNetPP
    ...
    num_dense_loop = 1 # Number of Dense Blocks in the BottleNeck Layer
    ...
    #
    Model = BCDUNet(length, model_depth, num_channel, model_width, kernel_size, problem_type=problem_type, output_nums=output_nums, ds=D_S, ae=A_E, ag=A_G, lstm=LSTM,
                    dense_loop=num_dense_loop, is_transconv=is_transconv).BCDUNet()
